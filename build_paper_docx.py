#!/usr/bin/env python3
"""Build 'The Arctic Lens — Combined Paper (EN).docx' (matched to Tavola 1/2/3)."""
...
para([("The spatial lineage of The Arctic Lens derives directly from Tomás Saraceno's ", False, False),
      ("Cloud Cities", False, True), (" and ", False, False), ("Arachnophilia", False, True),
...
bullet([("Land Access (Territorial Master Plan — Tavola 1, Scale 1:7500):", True, False), (" A spur from highway E10 enters a granite tunnel leading to a subsurface smart logistics terminal carved 15 m inside the mountain, completely invisible from the exterior landscape.", False, False)])
...
h2("4.1 Cluster Zoning and Tier Stratification (Tavola 2)")
para([("The 32 pods are not distributed uniformly: the cluster is organized into four functional sectors and rises through four main spatial tiers:", False, False)])
bullet([("Cluster Zoning (Tavola 2, Scale 1:750):", True, False), (" the matrix is zoned into four sectors — The Core Research Nucleus, The Logistics / Life-Support System, The Habitat & Biosphere, and The Eco-Cultivation.", False, False)])
bullet([("Tier Stratification (Tavola 2):", True, False), (" the modules are distributed across four main spatial tiers, from +24.00 m to +96.00 m, with the level stratification marked at +0.00 / +24.00 / +48.00 / +72.00 / +96.00 m.", False, False)])
para([("This stratification maximizes natural illumination and aerodynamic wind mitigation while preserving the floating, structural equilibrium of the whole.", False, False)])
h2("4.2 Pod Sectional Stratification (Tavola 3 — Section A-A, Scale 1:100)")
para([("Within each pod, the vertical axis is stratified across three floors, each rising 8 m between the four primary elevation datums (+0.00 / +8.00 / +16.00 / +24.00 m):", False, False)])
bullet([("Lower Level (+0.00 m to +8.00 m) — Ground Floor (Entry & Technical Core):", True, False), (" the pressurized environmental Air Lock, Lobby/Entry, Provisions/Storage, and the MEP life-support systems — together with the seawater heat-pump units drawing +4°C to +6°C thermal energy from a sea depth of 15 m. This is the pod's primary structural and mechanical base.", False, False)])
bullet([("Mid Level (+8.00 m to +16.00 m) — First Floor (Research & Interactive Zone):", True, False), (" the active scientific domain — a Wet Lab for environmental sampling, a Dry Lab & IT Server Core, climate-controlled Hydro-Gardens/aquaponics for biological sustainment, and a central Collaboration Space.", False, False)])
bullet([("Upper Level (+16.00 m to +24.00 m) — Second Floor (Residential & Wellness Habitat):", True, False), (" the uppermost private tier optimized for crew well-being — compact Sleeping Quarters, a Kitchenette & Dining zone, bathroom facilities, a Wellness area, and a central Quiet Lounge — capped by the transparent polyhedral dome and its unfritted 7.3 m ETFE zenith lens, which operates as a living sundial under the Midnight Sun and a viewing dome for the Aurora Borealis in winter.", False, False)])
h2("4.3 Structural Anchoring & Cable Network (Tavola 2 — Scale 1:750)")
